"""
Django settings for WattControl project.
...
SECRET_KEY = 'django-insecure-n5sp690m5(23)lyg&$$onoo_lpc%)g6vciy$9qbwx&(ur@z2a_'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('MYSQL_DATABASE', 'wattcontrol'),
        'USER': 'root',
        'PASSWORD': os.getenv('MYSQL_ROOT_PASSWORD', 'Carlos123456'),
        'HOST': 'wattcontrol_db',  # Nombre del servicio definido en docker-compose.yml
